...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX "movies_genres_order_idx" ON "movies_genres" USING btree ("_order");
  CREATE INDEX "movies_genres_parent_id_idx" ON "movies_genres" USING btree ("_parent_id");
  CREATE INDEX "movies_poster_idx" ON "movies" USING btree ("poster_id");
  CREATE INDEX "movies_updated_at_idx" ON "movies" USING btree ("updated_at");
  CREATE INDEX "movies_created_at_idx" ON "movies" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_movies_id_idx" ON "payload_locked_documents_rels" USING btree ("movies_id");
